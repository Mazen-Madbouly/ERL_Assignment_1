...
def generate_launch_description():
    ...
    pkg_erl_assignment_1 = FindPackageShare('erl_assignment_1')
    default_rviz_config_path = PathJoinSubstitution([pkg_erl_assignment_1, 'rviz', 'urdf.rviz'])
